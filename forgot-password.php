...
<body>
  <div class="login">
    <form action="forgot-password.php" method="POST" autocomplete="">
                    <h2 style="color: white;text-align: center;"><u>Forgot Password</u></h2><br>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="email" name="email" placeholder="Enter email address"  style="width: 300px;" required value="<?php echo $email ?>">
                    </div>
                    <div class="form-group">
