...
<div class="div1">
	<!-- input type="button" name="bt1" onclick="fun2()" value="Academic Section Form" class="bts1">
...
<!-- <tr><td><label for="phn"><b>Phone Number</b></label></td><td>
    <input type="tel" placeholder="Enter the phone number" name="phn" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required></td>
    </tr> -->
...
<tr><td>
    ...
    <input type="tel" placeholder="Enter the register no" name="reg" pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}" required><br></td>
    </tr>
<tr><td>
...
<tr><td>
    <label for="reg">Register No.</label></td><td>
    <input type="text" placeholder="Enter the register no" name="reg" value="" required value="Number" required><br></td>
    </tr>
<tr><td>
    <label for="name">Name</label></td><td>
    <input type="text" placeholder="Enter the name" name="name" required></td>
