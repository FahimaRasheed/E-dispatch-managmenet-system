      ...
      <ul>
        <li>
          ...
          <input type="checkbox" id="check">
                ...
                <div class="search">
                    <form method="post" action="inbox.php" class="search-bar">
...
<div class="form-popup" id="myForm">
  <form class="form-container" method="post" action="inbox2.php" >
...
alert("Empty...");
  ...
  $qry="select * from dispatch where subject like '%$search%' and type='received'";
