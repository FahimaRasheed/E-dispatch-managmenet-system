          ...
          <input type="checkbox" id="check" onclick="">
                ...
                <div class="search">
                    <!-- <form action="" class="search-bar"> -->
                      <!-- <button type="reset" class="btn cancel" id="btns" name="view" onclick="openss()">View Caution Deposit</button> -->
...
<div class="form-" id="myForme">
  <form method="post" action="viewcaution.php" class="form-container">
