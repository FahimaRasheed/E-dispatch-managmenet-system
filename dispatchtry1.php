...
function openForm() {
  ...
  // window.location.href="dispatchsearch.php";
...
function edited()
  {
    ...
    window.location.href="dispatchedit.php";
      ...
      <ul>
        <li>
          ...
          <input type="checkbox" id="check">
                ...
                <!--  <button type="reset" class="btn cancel" name="view" onclick="editss()" style="margin-left: 350px; margin-top: 20px;width: 50px;height: 40px;background-color: #1c7575;
  color: white; border: 2px solid #1c7575;">Edit</button> -->
                <div class="search">
...
<tr><td>
    ...
    <select name="to" id="to" onchange="if(this.options[this.selectedIndex].value=='customOption'){ toggleField(this,this.nextSibling); this.selectedIndex='0'; }" required>
      <option>select</option>
      <option value="customOption">[type a custom value]</option>
      <option value="Vice-Chancellor’s Secretariat">Vice-Chancellor’s Secretariat</option>
      <option value="Director’s Secretariat, SEI&RR">Director’s Secretariat, SEI&RR</option>
...
<option value="Dr. Krishnapriya">Dr. Krishnapriya(Assistant Professor)</option>
  ...
  color: grey;" disabled="disabled" onblur="if(this.value==''){toggleField(this,this.previousSibling);}">
    ...
    <input type="text" placeholder="Enter the Subject" name="subject" value="" required><br></td>
    </tr>
    <tr></tr>
    <tr><center><td>
    
    <button type="submit" class="btn" onclick="openbtn()" name="create">Create</button></center></td><td>
      <!-- <button type="reset" class="btn cancel" onclick="edited()">Edit</button> -->
 <!-- <button type="reset" class="btn cancel" name="view" onclick="edited()" style="margin-left: 25px; margin-top: 0px;width: 60px;height: 40px;background-color: #1c7575;
  color: white; border: 2px solid #1c7575;align-items: center;padding: 16px 29px;width: 100px;"></button> -->
 </td></center></tr>
    </table>
  </form>
</div>
...
(Assistant Professor)</option>
    ...
    <button type="submit" class="btn" name="saved">Save</button></center></td><td>
<button type="reset" class="btn cancel" onclick="closeFo()">Close</button>
 </td></center></tr>
    </table>
  </form>
</div> -->
